...
/*:
* @plugindesc v.10.0.8 [MV] Advanced project testing and various functions. Made with ♥ by DKPlugins.
* @author DKPlugins
* @help
...
/*:ru
* @plugindesc v.10.0.8 [MV] Расширенное тестирование проекта и различные функции. Сделано с ♥ от DKPlugins.
* @author DKPlugins
* @help
...
window.Imported.DKTools = '10.0.8';
...
ImageManager.loadNormalBitmap = function(path, hue) {
    return DKTools_ImageManager_loadNormalBitmap.call(
        this, DKTools.IO.reverseSlashes(decodeURIComponent(path)), hue);
};
...
ImageManager.reserveNormalBitmap = function(path, hue, reservationId) {
    return DKTools_ImageManager_reserveNormalBitmap.call(
        this, DKTools.IO.reverseSlashes(decodeURIComponent(path)), hue, reservationId);
};
